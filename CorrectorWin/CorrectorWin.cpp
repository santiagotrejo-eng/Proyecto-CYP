...
// CorrectorWin.cpp : define los comportamientos de las clases para la aplicación.
//
...
// Construcción de CCorrectorWinApp
...
// El único objeto CCorrectorWinApp

CCorrectorWinApp theApp;


// Inicialización de CCorrectorWinApp
